...
import { FilterOperatorDto } from './dto/filter-operation.dto';
...
export class FilteringService {
  ...
  compare(filterOperatorDto: FilterOperatorDto) {
    if (!filterOperatorDto) return;
    const { operands, operator } = filterOperatorDto;
